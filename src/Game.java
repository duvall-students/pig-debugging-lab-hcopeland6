...
//		Player player2 = new ComputerPlayer();
		...
		// No need to initialize it again since it is already initialized at the class
		// level, removed object pointer
	...
	/*
	 * One player's turn. Ends because - roll a 1 - spin a "GRUNT" - or Player
	 * decides to stop
	 * 
	...
	public int takeATurn(Player whoseTurn) {
		...
		while (keepGoing) {
			int roll = die.nextInt(6) + 1; // Adds one to the value to keep it from being 0
...
//			}
			...
			// need to flip these two if statements so that the
			// loser spin would happen first since it achieves what both the spin and roll
	...
	public boolean winner() {
		...
		// Changed because a win condition cannot be both, it would have to be either or
